...
const seed = async () => {
  ...
  const groetOpties = [
    { id: '4ca904f3-3c40-4882-a3d8-94457e384a85', name: 'Met vriendelijke groet,' },
    { id: 'ebdefd38-763f-4542-9783-986cd309fb9c', name: 'Hartelijke groet,' },
    {
      id: '26d4c859-5b9a-41f9-9e3f-6a451ca3a03a',
      name: 'Hoogachtend,'
    }
  ];
